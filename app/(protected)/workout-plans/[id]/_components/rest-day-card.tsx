// frontend/app/(protected)/workout-plans/[id]/_components/rest-day-card.tsx
...
export function RestDayCard({ weekDay }: RestDayCardProps) {
  return (
    <div className="flex h-27.5 w-full flex-col items-start justify-between rounded-xl bg-muted p-5 transition-all duration-200">
